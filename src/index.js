...
app.use((req, res, next) => { if (req.path === '/api/videos/upload') return next(); csrfProtection(req, res, next); });
...
app.post('/api/test-upload', (req, res) => { console.log('TEST ENDPOINT HIT'); res.json({ success: true, message: 'Test works' }); });
